...
export default function LeverageThanks() {
  return (
      ...
      <div className="max-w-2xl mx-auto space-y-8 text-center">
        ...
        <div className="space-y-4">
          ...
          <p className="text-vault-muted text-lg">
            Your info is submitted. Book a 15-minute diagnostic call below and we'll tell you exactly which lenders match your debt-to-income profile — no credit pull on this call.
          </p>
        </div>
